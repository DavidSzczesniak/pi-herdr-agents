...
const taskBase = { ...correlation, piSessionId: Type.String(), task: Type.String(), startedAt: Type.String() };
...
export const ResultSchema = Type.Union([
  Type.Object({ kind: Type.Literal("status"), identity: IdentitySchema, active: Type.Union([TaskSchema, Type.Null()]), idle: Type.Boolean() }),
  Type.Object({ kind: Type.Literal("accepted"), ...correlation, evidence: Type.Literal("agent_start") }),
  Type.Object({ kind: Type.Literal("ambiguous"), ...correlation, reason: Type.String() }),
